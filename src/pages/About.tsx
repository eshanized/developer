      ...
      <div className="relative py-8 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h1 className="text-2xl md:text-4xl font-bold mb-2 md:mb-4 text-gray-900 dark:text-white">
              {developerInfo.name}
            </h1>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                <div className="card bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-lg transition-shadow p-4 md:p-6">
                  <div className="flex flex-col items-center">
                    ...
                    <h3 className="font-semibold dark:text-white text-sm md:text-base">
                      Experience
                    </h3>
                ...
                <div className="card bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-lg transition-shadow p-4 md:p-6">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                      {developerInfo.skills.length}+ Tools
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 md:p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-4 md:space-y-6">
                  {developerInfo.education.map((edu, index) => (
                    <div
                      key={index}
                      className="card bg-white/90 dark:bg-gray-700/90 hover:shadow-md transition-shadow p-4 md:p-6"
                    >
                      <div className="flex items-start space-x-3 md:space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base mb-1">
                            {edu.institution}
                          </p>
                ...
                {languagesLoading ? (
                  <div className="animate-pulse space-y-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="h-8 bg-gray-200 dark:bg-gray-700 rounded-full w-full"
                      />
                    ))}
                  </div>
                ) : (
