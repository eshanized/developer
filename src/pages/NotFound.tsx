...
const NotFound = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] relative overflow-hidden">
      ...
      <div className={`relative flex items-center justify-center min-h-[calc(100vh-8rem)] transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
