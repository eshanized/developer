...
const SEOHead = () => {
  useEffect(() => {
    ...
    updateMetaTag('og:image', `https://github.com/${developerInfo.social.github}.png`);
    updateMetaTag('og:url', window.location.href);

    // Update Twitter tags
    updateMetaTag('twitter:title', `${developerInfo.name} - ${developerInfo.title}`);
    updateMetaTag('twitter:description', description);
    updateMetaTag('twitter:image', `https://github.com/${developerInfo.social.github}.png`);
