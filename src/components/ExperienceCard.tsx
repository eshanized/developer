    ...
    <div className="card bg-white/90 dark:bg-gray-700/90 p-4 md:p-6">
      <div className="flex items-start space-x-3 md:space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white truncate">{position}</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base mb-2">{company} • {period}</p>
